...
import React, { memo, useEffect, useState } from 'react'; // Import memo
...
import { problemStatuses } from '../constants';
...
const ProblemDetailModal: React.FC<ProblemDetailModalProps> = memo(
  ({ problem, isOpen, onClose, onSave }) => {
        ...
        <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto flex flex-col">
          ...
          <div className="flex justify-between items-center mb-6 pb-4 border-b border-slate-200">
            ...
            <button
              ...
              aria-label="Close problem details modal"
            >
              <X size={28} />
            </button>
          </div>
          ...
          <div className="space-y-6 mb-6">
            ...
            <div className="space-y-2">
              ...
              {(editableProblem.solutionLinks ?? []).map((link) => (
                ...
                >
                  ...
                  <button
                    ...
                    aria-label={`Remove solution link ${link.name}`}
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
              ...
              <div className="flex gap-2 items-end">
                <input
                  ...
                  className="flex-1 p-2 border border-slate-300 rounded-md text-sm focus:ring-1 focus:ring-blue-500"
                  aria-label="New solution link name"
                />
                <input
                  type="url"
                  value={newLinkUrl}
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      aria-label={`Remove attempt on ${attempt.date}`}
                    >
                      <Trash2 size={16} />
                    </button>
                  </div>
            ...
            <div className="space-y-2">
              <h3 className="text-md font-semibold text-slate-700 flex items-center">
                <ListChecks size={18} className="mr-2" aria-hidden="true" />
                Sub-tasks/Steps:
              </h3>
                ...
                >
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      aria-labelledby={`subtask-label-${task.id}`}
                    />
                    <span
                      id={`subtask-label-${task.id}`}
                      className={
                  ...
                  <button
                    ...
                    className="text-red-500 hover:text-red-700 ml-2"
                    aria-label={`Remove sub-task ${task.text}`}
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
...
ProblemDetailModal.displayName = 'ProblemDetailModal'; // Add display name for memoized component
